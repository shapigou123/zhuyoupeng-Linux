...
/********************************动态映射******************************/
	...
	if(!request_mem_region(GPJ0BASE_PA, sizeof(gpj0_reg_t), "GPJ0REG"))
		//return -EINVAL;	
	goto flag3;
	...
	*pGPJ0DAT = ((0<<3)|(1<<4)|(0<<5));	
	...
	pGPJ0REG = ioremap(GPJ0BASE_PA, sizeof(gpj0_reg_t));
	pGPJ0REG->gpj0con = 0x11111111;
	//pGPJ0REG->gpj0dat = ((0<<3)|(1<<4)|(0<<5));;
	writel(((0<<3) | (0<<4) | (0<<5)), GPJ0DAT);
/**********************************************************************/
...
/*************************动态映射解除*********************************/
	...
	*pGPJ0DAT = ((1<<3) | (0<<4) | (1<<5));	
	...
	pGPJ0REG->gpj0dat = ((1<<3) | (1<<4) | (1<<5));	
	iounmap(pGPJ0REG);
	release_mem_region(GPJ0BASE_PA, sizeof(gpj0_reg_t));
/**********************************************************************/	
